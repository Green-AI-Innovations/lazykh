raise NotImplementedError(
    "This file is not meant to be run for now. The code depends on pygame, which is not"
    + " added to the pyproject.toml file. Also, the need for this file is not "
    + "clear, since we intend to deploy the app as a web API. If you want to run this "
    + "file, you'll need to install pygame and add it to the pyproject.toml file."
)
