...
def text_to_speech(transcript,path_name,actor="en-US-JennyNeural"):
   ...
   api_key = 'af6821f1ff0d4b99a6fd062c5301727a' # we will integrate azure key vault soon
   region = 'westeurope'
   ...
   if speech_result.reason == speechsdk.ResultReason.SynthesizingAudioCompleted:
      ...
      print(f"Speech synthesized with voice '{voice}' and saved to {output_file_path}")
   else:
